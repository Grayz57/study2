...
class Constants(BaseConstants):
    name_in_url = 'abarrrjeezaeezaeazazear'
...
class Decision(Page):
    ...
    def vars_for_template(player: Player):
        ...
        black_draw = const.events_table[player.part][player.event]["fortemplate"]["black_draw"]
        red_draw = const.events_table[player.part][player.event]["fortemplate"]["red_draw"]
        yellow_draw = const.events_table[player.part][player.event]["fortemplate"]["yellow_draw"]
        draw = const.events_table[player.part][player.event]["fortemplate"]["draw"]
